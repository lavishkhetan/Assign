...
public class TegaAccountManagement extends BaseUI {

	Initializer test;
	
	public TegaAccountManagement(WebDriver driver) {
		super(driver);}
	...
	@FindBy(xpath="//select[@id='ddlPrivilegeLevel']//option[@value='TegaAccountManagement']")
	private WebElement Privelege_Enterprise;
//	Client List
	@FindBy(xpath="//tr[@class='odd'][1]//input[@class='chk']")
...
//	Reset Password Locators		
	...
	public void CreateTegaAcc() throws Exception{
...
//	Navigate to Add User Page
			...
			Enter_username.sendKeys("Tega_TAM_1");
	...
	public void ResetPassword_TAM() throws Exception{
		Tega_Admin_username.sendKeys("Tega_TAM_1");
	...
	public void EnterpriseLogin_TAM(){
		Tega_Admin_username.sendKeys("Tega_TAM_1");
		Tega_Admin_password.sendKeys("Ishir@123");
		Tega_Admin_Signinbtn.click();
		Select_Enterprise.click();
