...
public class SegmentUser extends BaseUI{

	Initializer test;
	public SegmentUser(WebDriver driver) {
		super(driver);
	}
...
// 	Add User Page
	@FindBy(xpath="//select[@id='ddlPrivilegeLevel']//option[@value='SegmentUser']")
...
//	Re-login into the Application
	...
	public void CreateSegUser() throws Exception{
...
//	Navigate to Add User Page
		...
		Enter_username.sendKeys("Tega_SU_1");
	...
	public void ResetPassword_SU() throws Exception{
		Segment_Admin_username.sendKeys("Tega_SU_1");
	...
	public void EnterpriseLogin_SU() throws Exception{
		Segment_Admin_username.sendKeys("Tega_SU_1");
		Segment_Admin_password.sendKeys("Ishir@123");
		Segment_Admin_Signinbtn.click();	
		}
