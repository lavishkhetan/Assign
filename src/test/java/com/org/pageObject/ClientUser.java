...
public class ClientUser extends ClientAdmin {

	Initializer test;
	
	public ClientUser(WebDriver driver) {
		super(driver);
	}
	@FindBy(xpath="//input[@id='inputUsername']")
	private WebElement Client_Admin_username;
	@FindBy(xpath="//input[@id='inputPassword']")
	private WebElement Client_Admin_password;
	@FindBy(xpath="//button[@id='btnSignIn']")
	private WebElement Client_Admin_Signinbtn;
	...
	@FindBy(xpath="//select[@id='ddlPrivilegeLevel']//option[@value='ClientUser']")
...
//	Re-login into the Application
	...
	public void CreateCntUser() throws Exception{
//		Login into the application		
		Client_Admin_username.sendKeys("Tega_CA_1");
		Client_Admin_password.sendKeys("Ishir@123");
		Client_Admin_Signinbtn.click();
		Thread.sleep(3000);
...
//	Navigate to Add User Page
		...
		Enter_username.sendKeys("Tega_CU_2");
	...
	public void ResetPassword_CU() throws Exception{
		Client_Admin_username.sendKeys("Tega_CU_2");
		Client_Admin_password.sendKeys("test");
		Client_Admin_Signinbtn.click();
		Thread.sleep(1000);
	...
	public void EnterpriseLogin_CU() throws Exception{
		Client_Admin_username.sendKeys("Tega_CU_2");
		Client_Admin_password.sendKeys("Ishir@123");
		Client_Admin_Signinbtn.click();
	}
