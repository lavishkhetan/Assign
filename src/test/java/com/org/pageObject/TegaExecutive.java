...
import com.org.ishir.initiators.Initializer;
	...
	public class TegaExecutive extends BaseUI{
	
		Initializer test;
	
	public TegaExecutive(WebDriver driver) {
		super(driver);
	}
	...
	@FindBy(xpath="//select[@id='ddlPrivilegeLevel']//option[@value='TegaExecutive']")
...
//
	...
	public void CreateTegaExe() throws Exception{
...
//		Navigate to Add User Page
			...
			Enter_username.sendKeys("Tega_TE_1");
	...
	public void ResetPassword_TE() throws Exception{
		Tega_Admin_username.sendKeys("Tega_TE_1");
	...
	public void EnterpriseLogin_TE() throws Exception{
		Tega_Admin_username.sendKeys("Tega_TE_1");
		Tega_Admin_password.sendKeys("Ishir@123");
		Tega_Admin_Signinbtn.click();
		Thread.sleep(1000);
