...
public class EnterpriseAdmin extends BaseUI {

	Initializer test;
	
	public EnterpriseAdmin(WebDriver driver) {
		super(driver);
	}	
		...
		@FindBy(xpath="//select[@id='ddlPrivilegeLevel']//option[@value='EnterpriseAdmin']")
		private WebElement Privelege_Enterprise;
		@FindBy(xpath="//select[@id='ddlEnterprise']//option[@value='1']")
...
// Reset Password Locators		
	...
	public void CreateEntAdmin() throws Exception{
//	Login into the application		
		Enterprise_Admin_username.sendKeys("lkhetan");
...
//	Navigate to Add User Page
		...
		Enter_username.sendKeys("Tega_EA_4");
...
//	Re-Login and Reseting the Password
		public void ResetPassword_EA() throws Exception{		
		Enterprise_Admin_username.sendKeys("Tega_EA_4");
		...
		public void Enterpriselogin_EA() throws Exception{
		Enterprise_Admin_username.sendKeys("Tega_EA_4");
		Enterprise_Admin_password.sendKeys("Ishir@123");
		Enterprise_Admin_Signinbtn.click();
		}
